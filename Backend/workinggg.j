...
app.use(cors({
  origin: [
    ...
    "http://16.171.195.252:3409",
    "http://16.171.195.252:5500",
    "http://16.171.195.252:5500",
    "http://16.171.195.252:5501",
    "http://16.171.195.252:5503", // Added to allow requests from this origin
    "http://16.171.195.252:5503", // Added to allow requests from this origin
    "http://16.171.195.252:8027",
    "http://16.171.195.252:8028"
  ],
